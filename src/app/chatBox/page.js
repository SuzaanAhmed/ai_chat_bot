                            ...
                            parts: [
                                {
                                    text: `
                                            ...
                                            2. Convert into japanese langauage 
        ...
        <div className="flex flex-row min-h-screen bg-gray-200">
            <div className="flex flex-col w-[250px] bg-gray-900 text-white p-4">
                <button
                    ...
                    onClick={() => setConverse([...converse, { title: 'Converse', messages: [] }])}
                >
                    <PlusIcon />
                    <span>New Chat</span>
                </button>
                ...
                <div className="flex flex-col gap-2">
                    {converse.map((conv, index) => (
                        <div key={index} className="flex items-center gap-2 p-2 hover:bg-gray-700 rounded cursor-pointer">
                            <MessageSquareIcon />
                            <p>{conv.title}</p>
                        </div>
                    ))}
            ...
            <div className="flex flex-col flex-1 bg-white shadow-lg">
                ...
                <div className="flex justify-center items-center p-4 mt-auto">
                    ...
                    >
                        <img src="send_text.png" className="h-[30px] w-[30px]" />
                    </button>
                </div>
            </div>
        </div>
